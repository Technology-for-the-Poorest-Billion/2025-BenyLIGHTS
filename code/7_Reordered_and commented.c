...
// initialisation for the interupts 
void EXTI0_INT_INIT(void)
{
    ...
    EXTI_InitStructure.EXTI_Trigger = EXTI_Trigger_Rising; //pin is initially set as low, so rising triggers interrupt
...
// functions that return floats, 4 seperate functions since cannot return multiple from same function 
