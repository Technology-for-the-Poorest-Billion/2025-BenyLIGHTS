...
int main(void)
{
    ...
    while(1)
    {
        ...
        /* TRIED TO MAKE AVERAGING CODE BUT DIDN'T WORK if (x<samples)
        {
        ...
        if (x == samples)
        {
            ...
            int wholePart = (int)avg_bat;
            int decimalPart = (int)((avg_bat - wholePart) * 10000);
            printf("AVERAGE BATTERY : %d.%04d ", wholePart, decimalPart);
            x = 0;
        } */
