...
// Initialise the GPIO pin GPIOD GPIO_Pin_2 as an output
void DATA_INIT(void){
...
void LED_SendBit(uint8_t bit){
    if (bit) {
    //// Send a 1 bit
        GPIOD->BSHR = 1 << 2; // put pin C4 high and wait for 800nS
        ...
        GPIOD->BCR = 1 << 2; // put pin C4 low and exit, 400nS is taken up by other functions
//        __asm__("nop");__asm__("nop");__asm__("nop");__asm__("nop");
//        __asm__("nop");__asm__("nop"); __asm__("nop");__asm__("nop");
        ...
        // Send a 0 bit
        GPIOD->BSHR = 1 << 2; // put pin C4 high and wait for 400nS
            __asm__("nop");__asm__("nop");__asm__("nop");__asm__("nop");
            __asm__("nop");__asm__("nop");__asm__("nop");__asm__("nop");
            __asm__("nop");__asm__("nop");__asm__("nop");__asm__("nop");
            __asm__("nop");__asm__("nop");

        GPIOD->BCR = 1 << 2; // put pin C4 low and wait for 400nS, 400nS is taken up by other functions
            __asm__("nop");__asm__("nop");__asm__("nop");__asm__("nop");
            __asm__("nop");__asm__("nop");__asm__("nop");__asm__("nop");
            __asm__("nop");__asm__("nop");__asm__("nop");__asm__("nop");
//            __asm__("nop");__asm__("nop");__asm__("nop");__asm__("nop");
