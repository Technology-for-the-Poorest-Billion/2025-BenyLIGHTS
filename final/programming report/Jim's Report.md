...
Me and Lucy worked together on lots of the programming, further detail can be found both on [Lucy](Lucy's Report)'s page and for fully commented code all iterations are available on the [code](code) page.
### Battery status 
