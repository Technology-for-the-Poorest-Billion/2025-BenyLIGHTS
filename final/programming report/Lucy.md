...
To solve this issue, I tried to reduce the large jump in brightness. I changed the step PWM percentage values to [0, 10, 25, 45, 70] which still provides good variation in brightness levels and solves the browning out issue. 
